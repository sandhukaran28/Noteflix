...
- **Video timestamp:** 01:10 – 01:52 (login + endpoints), 03:10 – 03:20 (logs/output)  
- **Relevant files:**
...
- **Video timestamp:** 01:25 – 01:32 (upload/list), 02:47 – 03:00 (finished job output)  
- **Relevant files:**
    - `/src/routes/assets.js`  
    - `/src/routes/jobs.js`  
